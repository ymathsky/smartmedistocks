...
<div class="p-5 max-w-screen-2xl mx-auto">
    ...
    <div class="flex flex-wrap justify-between items-center mb-7 gap-3">
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <a href="demo_data_reset.php" class="inline-flex items-center gap-1.5 text-xs font-semibold bg-purple-600 hover:bg-purple-700 text-white px-3 py-2 rounded-lg shadow-sm transition">
