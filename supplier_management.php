...
// UPDATED SQL: Fetch the new 'address' column
$sql = "SELECT supplier_id, name, contact_info, address, average_lead_time_days, created_at FROM suppliers ORDER BY name ASC";
...
<div class="p-6">
    <div class="bg-white p-8 rounded-lg shadow-md w-full">
        ...
        <?php
        // Display success or error messages (already protected in the calling page)
        ...
        <div class="overflow-x-auto">
            ...
            <table class="min-w-full bg-white border" id="supplierTable">
                <thead class="bg-gray-800 text-white">
                <tr>
                    <th class="py-3 px-4 uppercase font-semibold text-sm text-left">Supplier Name</th>
                    <th class="py-3 px-4 uppercase font-semibold text-sm text-left">Address</th> <!-- NEW HEADER -->
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="py-3 px-4 text-sm"><?php echo nl2br(htmlspecialchars($row['address'])); ?></td> <!-- NEW CELL -->
                            ...
                            <td class="py-3 px-4"><?php echo htmlspecialchars(date("F j, Y", strtotime($row['created_at']))); ?></td>
                            <td class="py-3 px-4 text-center">
                                <!-- Sanitized IDs in URL parameter -->
                                <a href="edit_supplier.php?id=<?php echo htmlspecialchars($row['supplier_id']); ?>" class="text-blue-600 hover:underline">Edit</a>
