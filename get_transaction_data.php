...
if ($result) {
    while ($row = $result->fetch_assoc()) {
        ...
        $data[] = [
            'transaction_id' => $row['transaction_id'], // Include ID for actions
            'date' => htmlspecialchars(date("M j, Y", strtotime($row['transaction_date']))), // Format date
            'item_code' => htmlspecialchars($row['item_code']),
            'item_name' => htmlspecialchars($row['item_name']),
            'quantity_used' => htmlspecialchars($row['quantity_used']),
            'actions' => '' // Placeholder for actions, will be generated by JS
        ];
    }
} else {
