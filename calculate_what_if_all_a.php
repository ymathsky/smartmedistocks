...
ob_start(); // Buffer output so shutdown function can clear partial output
...
// Select A-class = cumulative ACV up to 80%
$a_items   = [];
$cumulative = 0;
...
// Use integer IDs directly in query (safe: all are cast to int)
