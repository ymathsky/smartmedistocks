...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validate the inputs
    if (empty($hospitalName) || empty($hospitalAddress) || !$alertRecipientEmail || $serviceLevel === false || $holdingCostRate === false || $orderingCost === false || $serviceLevel < 0 || $holdingCostRate < 0 || $orderingCost < 0) {
    ...
    $stmt->bind_param("ssssssssssss", $hn_name, $hospitalName, $ha_name, $hospitalAddress, $are_name, $alertRecipientEmail, $sl_name, $serviceLevel, $hcr_name, $holdingCostRate, $oc_name, $orderingCost);
